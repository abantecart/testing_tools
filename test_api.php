	...
	<script>
		...
		function getLatest () {
			...
			$.ajax({
				type: 'GET',
				url: abantecart_url,
				data: {'rt': 'a/product/latest', 'token' : token, 'api_key' : $('#api_key').val() },
				success: function (data)
				{
					showResponse(this, data);
				},
	...
	<div id="search_section">
		<div class="container">
			...
			<div class="field clear">
				...
				<a href="javascript:getLatest();" class="btn_standard float_left"><span title="Latest Products"><span>Latest Products</span></span></a>
